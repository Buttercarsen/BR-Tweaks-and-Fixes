...
- Install the latest version of [uv](https://docs.astral.sh/uv/getting-started/installation/) using the instructions from their website.
...
- Double-click the `BR.bat` file in the root of the install folder.
  - This will print your Python and uv versions, run `uv sync` to install BR's dependencies, and and then run "BasementRenovator.py".
